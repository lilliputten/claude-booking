import { getFormattedRelativeDate } from '../dates';
...
describe('getFormattedRelativeDate', () => {
  ...
  describe('relative dates (within a day)', () => {
    it('should return seconds for very recent dates (less than 1 minute)', () => {
      ...
      const result = getFormattedRelativeDate(recentDate, mockNow);
    ...
    it('should return minutes for dates within an hour', () => {
      ...
      const result = getFormattedRelativeDate(withinHourDate, mockNow);
    ...
    it('should return hours for dates within a day', () => {
      ...
      const result = getFormattedRelativeDate(withinDayDate, mockNow);
    ...
    it('should return hours for dates just under 24 hours', () => {
      ...
      const result = getFormattedRelativeDate(justUnderDayDate, mockNow);
  ...
  describe('full dates (older than a day)', () => {
    it('should return full date for dates older than 24 hours', () => {
      ...
      const result = getFormattedRelativeDate(olderDate, mockNow);
    ...
    it('should return full date for dates exactly 24 hours ago', () => {
      ...
      const result = getFormattedRelativeDate(exactlyDayAgo, mockNow);
    ...
    it('should include year for dates older than 6 months', () => {
      ...
      const result = getFormattedRelativeDate(oldDate, mockNow);
    ...
    it('should not include year for dates within 6 months', () => {
      ...
      const result = getFormattedRelativeDate(recentOldDate, mockNow);
  ...
  describe('edge cases', () => {
    it('should handle future dates', () => {
      ...
      const result = getFormattedRelativeDate(futureDate, mockNow);
